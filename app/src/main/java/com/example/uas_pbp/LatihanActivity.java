...
import com.example.uas_pbp.adapters.LatihanAdapter;
import com.example.uas_pbp.api.LatihanApi;
import com.example.uas_pbp.content.TampilDataAlphabet;
import com.example.uas_pbp.geolocation.GeoActivity;
import com.example.uas_pbp.model.LatihanResponse;
...
public class LatihanActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId() == R.id.note){
            startActivity(new Intent(LatihanActivity.this, NoteActivity.class));
            overridePendingTransition(0, 0);
            finish();
        }
